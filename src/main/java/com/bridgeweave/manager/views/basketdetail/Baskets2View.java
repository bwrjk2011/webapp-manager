...
@PageTitle("Baskets2")
@Route(value = "Baskets2/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("USER")
@Uses(Icon.class)
public class Baskets2View extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "Baskets2/%s/edit";
...
//    private final CollaborationBinder<SamplePerson> binder;
    ...
    public Baskets2View(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("baskets2-view");
...
//        avatarGroup.getStyle().set("visibility", "hidden");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(Baskets2View.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(Baskets2View.class);
            }
        }
    }
